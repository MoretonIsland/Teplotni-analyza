...
foreach ($temperatures as $day => $cityTemperatures) {
    foreach ($cityTemperatures as $cityAbbreviation => $temperature) {
        ...
        // Přidání nové instance CityTemperature do pole $cities
        if (!isset($cities[$cityName])) {
            $cities[$cityName] = new CityTemperature($cityName, $cityAbbreviation, []); // Přidání zkratky města
        }
        // Přidání teploty do pole teplot u daného města
